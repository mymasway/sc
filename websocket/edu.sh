...
clear
# Link Hosting Kalian
MasWayVPN="raw.githubusercontent.com/mymasway/sc/main/websocket"

# Getting Proxy Template
wget -q -O /usr/local/bin/ws-nontls https://${MasWayVPN}/websocket.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-tls https://${MasWayVPN}/ws-tls
